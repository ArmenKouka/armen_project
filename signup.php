                   ...
                   $available="true";
                    ...
                    if ($result && mysqli_num_rows($result) >=0){
                         ...
                         if($available=="true"){
                              ...
                              $query= "insert into users (user_id,user_name,password,email,phone,date,gender,verification_code,email_verified_at) 
                                                  values ('$user_id','$user_name','$password','$email','$number','$date','$gender','$code',NULL)";
